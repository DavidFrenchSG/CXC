...
t <- describe(da)
write.csv(t, file="M_cluster_table2a.csv")
tt <- describeBy(da, da$cluster)
tt2<-do.call("rbind",tt)  
write.csv(tt2, file="M_cluster_table2b.csv")
...
write.csv(df, file="M_cluster_KW.csv")

write.csv(Mi, file="Mi_All_Clustered.csv")
